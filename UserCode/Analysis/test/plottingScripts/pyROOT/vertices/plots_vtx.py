...
# Plik wejściowy
file = ROOT.TFile.Open("../../../histos_PVdistance.root")
...
# Ustawienia tylko dla phiMass
phiMass_info = {
    "names": ["hGenPhotonFourMomentaMass", "hRecoPhotonFourMomentaMass", "hRecoMuons_RecoPhotonDir_GenPhotonMag", "hRecoMuons_GenPhotonDir_RecoPhotonMag"],

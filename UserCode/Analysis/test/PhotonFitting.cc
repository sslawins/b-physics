...
//object definition
class PhotonFitting : public edm::one::EDAnalyzer<> {
public:

  //constructor, function is called when new object is created
  explicit PhotonFitting(const edm::ParameterSet& conf);
...
PhotonFitting::PhotonFitting(const edm::ParameterSet& conf)
...
PhotonFitting::~PhotonFitting()
{
  cout <<" DTOR" << endl;
}

bool PhotonFitting::isSameDecay(const std::vector<int>& dec1, const std::vector<int>& dec2) {
...
void PhotonFitting::beginJob()
{
  ...
  cout << "HERE PhotonFitting::beginJob()" << endl;
}

void PhotonFitting::endJob()
{
  ...
  cout << "HERE PhotonFitting::endJob()" << endl;
}


void PhotonFitting::analyze(
    const edm::Event& ev, const edm::EventSetup& es)
{
  std::cout << " -------------------------------- HERE PhotonFitting::analyze "<< std::endl;
...
DEFINE_FWK_MODULE(PhotonFitting);

...
void ParticleMatcher<T>::matchRecoToGen(bool print) {
    std::cout << "Number of all reconstructed particles from this event: " << recoParticles.size() << std::endl;
    std::cout << "Number of all generated particles from the decay: " << genParticles.size() << std::endl;
